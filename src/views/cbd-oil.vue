...
<template>
  <div class="page-sign-up m-5 row">
    <div class="container p-5" style="text:justify-center">
        <h1 class="heading">CBD OIL</h1>
        <div class="pl-5 pr-5 m-5">
            <p class="mt-lg-5">Explore the different strengths and flavors of premium SunMed CBD <br> tinctures we have to offer – all lab tested, quality guaranteed!</p>
        </div>
...
name: 'cbd_oil',
  ...
  methods: {
      async getAllProducts() {
          ...
          axios.get('/api/v1/category/cbd_oil/')
          .then(response=>{
