<template>
          ...
          <img :src="require('@/assets/img/logo.jpeg')" alt="" style="background-size:contain;  background-repeat: no-repeat; text-align: center;width:100%">
           ...
           <div class="col-md-8 ">
              <form class="example ml-5" action="action_page.php" style="border-radius:15px;">
                <input type="text" placeholder="Search.." name="search" style="border-radius: 15px 0px 0px 15px;">
  ...
  <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                ...
                <div class="dropdown-menu p-4" style="border-radius:18px;" aria-labelledby="dropdownMenuButton">
                  <a class="dropdown-item btn btn-primary mt-4 mb-3" style="border-radius:14px;" href="/log-in">Sign In</a>
                  <a class="dropdown-item btn btn-outline mb-4"      style="border-radius:20px; background-color:white; border-color: black;"  href="/sign-up">Create An Account</a>
  ...
  <div class="container-fluid pt-2">
        <ul class="navbar-nav">
          ...
          <li class="nav-item mr-3 ml-3  dropdown" >
            <a class=" " style="color: black"  href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              Learn
            </a>
            <div class="dropdown-menu"  aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item mt-4 mb-4 ml-2 mr-2" href="/"><strong>Blog</strong>  </a>
              <a class="dropdown-item  mb-4 ml-2 mr-2" href="/"><strong>CBD 101</strong>  </a>
              <a class="dropdown-item  mb-4 ml-2 mr-2" href="/"><strong>Essential Oils</strong> </a>
              <a class="dropdown-item  mb-4 ml-2 mr-2" href="/"><strong>Terpenes</strong>  </a>
              <a class="dropdown-item  mb-4 ml-2 mr-2" href="/"><strong>FAQs</strong> </a>
            </div>
          </li>
          <li class="nav-item mr-3 ml-3  dropdown" >
            <a class=" " style="color: black"  href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="dropdown-menu"  aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item mt-4 mb-4 ml-2 mr-2" href="/"><strong>Our Communtiy</strong>  </a>
              <a class="dropdown-item  mb-4 ml-2 mr-2" href="/"><strong>Disclosures</strong>  </a>
            </div>
          </li>
          <li class="nav-item mr-3 ml-5">
            <a class="" style="color: black" href="/shop-all">About Us</a>
          </li>
          <li class="nav-item mr-3 ml-5">
    ...
    <!-- Footer -->
    <footer
      class="font-small footer"
      style="background-color: #f0f0f0; color: #818181 !important"
    >
      <!-- Footer Links -->
      <div class="text-center text-md-left pt-5 pb-5">
        <!-- Grid row -->
        <div class="row mt-4 ml-4 mr-4">
          ...
          <div class="col-md-2">
            <!-- Links -->
            <h5
              class="font-weight-bold text-uppercase mt-3 mb-4 ml-2"
              style="color: black"
            >
              Navigate
            </h5>
          ...
          <div class="col-md-4">
            ...
            <form  @submit.prevent="submitForm">
              <div class="row ml-4">
                ...
                <sub
                  >By subscribing you agree with our Terms of Use & Privacy
                  Policy.</sub
                >
              </div>
            </form>
            ...
            <p class="mt-5 mb-4 ml-4 pr-4" style="color: #818181 !important;">
              4815 Excelsior Boulevard Minneapolis, MN 55416 Email:
              info@growtolife.com <br />
              Call: (952) 405-8181 <br/> 
              Email: info@growtolife.com
            </p>

            <h5
              class="font-weight-bold text-uppercase mt-3 mb-4 ml-4 mt-2"
              style="color: black"
            >
               Connect With Us
            </h5>
            <div class="row pl-5 pr-5">
              <div claiss="col-3">
                <a href="https://www.facebook.com/grow2life">
                  <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="blue" class="bi bi-facebook" viewBox="0 0 16 16">
                    <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                  </svg> 
                </a>    
              </div>
              <div claiss="col-3">
                <a href="https://www.instagram.com/growtolife/">
                  <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="red" class="bi bi-instagram ml-4" viewBox="0 0 16 16">
              ...
              <div claiss="col-3">
                <a href="https://www.youtube.com/channel/UCeMEVgRGh2zAQlxhOvRvTww">
                  <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="red" class="bi bi-youtube ml-4 mb-4" viewBox="0 0 16 16">
              ...
              <div claiss="col-3">
                <a href="https://www.linkedin.com/company/growtolife/">
                  <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="blue" class="bi bi-linkedin ml-4 " viewBox="0 0 16 16">
      ...
      <div class="footer-copyright p-4">
        All hemp or CBD based products on this website contain .03% THC or less.
        No statement in this web site has been evaluated by the Food and Drug
        Administration (FDA). Furthermore, none of the statements in this web
        site should not be construed as dispensing medical advice or making
        claims regarding the cure of diseases. Products sold by Grow To Life are
